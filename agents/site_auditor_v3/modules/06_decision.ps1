. (Resolve-Path "agents/site_auditor_v3/lib/decision_action_map.ps1").Path
...
function Invoke-Module06Decision {
    ...
    $decisionAction = New-SiteAuditorV3DecisionAction -PipelineState $PipelineState -Verdict $verdict -Limitations $limitations -HasFindings $hasFindings
