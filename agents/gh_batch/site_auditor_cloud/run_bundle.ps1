...
function Invoke-WritingStage {
    ...
    try {
        ...
        Write-RunReportJson -FinalStatus $runReportStatus -RunId 'bundle-run' -FailedStep $runReportFailedStep -ErrorClass $runReportErrorClass -Message 'RUN_REPORT generated after report assembly and before validation.'
        ...
        Write-RunReportJson -FinalStatus 'FAIL' -RunId 'bundle-run' -FailedStep 'WRITING_STAGE' -ErrorClass 'WRITING_EXCEPTION' -Message "RUN_REPORT generated from writing-stage exception: $($_.Exception.Message)"
    }
